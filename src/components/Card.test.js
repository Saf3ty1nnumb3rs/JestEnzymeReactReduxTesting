...
describe('Card', () => {
    ...
    it('applies the `text-hidden` class to hide answer', () => {
        expect(card.find('.card-answer').hasClass('text-hidden')).toBe(true);
    });
    ...
    describe('when clicking on the card', () => {
        ...
        it('applies the `text-revealed` class to the card answer element', () => {
            expect(card.find('.card-answer').hasClass('text-revealed')).toBe(true);
        })
    });
})